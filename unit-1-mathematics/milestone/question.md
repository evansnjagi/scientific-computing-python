...
3. In `unit-1-mathematics/milestone/` folder, Write a script `gradient_descent_milestone.py`, that computes partial derivative of the function, $\frac{df}{dx}$ and $\frac{df}{dy}$. Reuse gradient and gradient descent functions, don't rewrite them. 
